...
// Source: github.com/fsobh/simplebank/db/sqlc (interfaces: Store)
//
...
// GetAllEntriesByAccountID mocks base method.
func (m *MockStore) GetAllEntriesByAccountID(arg0 context.Context, arg1 db.GetAllEntriesByAccountIDParams) ([]db.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllEntriesByAccountID", arg0, arg1)
	ret0, _ := ret[0].([]db.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAllEntriesByAccountID indicates an expected call of GetAllEntriesByAccountID.
func (mr *MockStoreMockRecorder) GetAllEntriesByAccountID(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllEntriesByAccountID", reflect.TypeOf((*MockStore)(nil).GetAllEntriesByAccountID), arg0, arg1)
}

// GetAllTransfersByBetween mocks base method.
func (m *MockStore) GetAllTransfersByBetween(arg0 context.Context, arg1 db.GetAllTransfersByBetweenParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllTransfersByBetween", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAllTransfersByBetween indicates an expected call of GetAllTransfersByBetween.
func (mr *MockStoreMockRecorder) GetAllTransfersByBetween(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllTransfersByBetween", reflect.TypeOf((*MockStore)(nil).GetAllTransfersByBetween), arg0, arg1)
}

// GetAllTransfersByFromAccountID mocks base method.
func (m *MockStore) GetAllTransfersByFromAccountID(arg0 context.Context, arg1 db.GetAllTransfersByFromAccountIDParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllTransfersByFromAccountID", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAllTransfersByFromAccountID indicates an expected call of GetAllTransfersByFromAccountID.
func (mr *MockStoreMockRecorder) GetAllTransfersByFromAccountID(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllTransfersByFromAccountID", reflect.TypeOf((*MockStore)(nil).GetAllTransfersByFromAccountID), arg0, arg1)
}

// GetAllTransfersByToAccountID mocks base method.
func (m *MockStore) GetAllTransfersByToAccountID(arg0 context.Context, arg1 db.GetAllTransfersByToAccountIDParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllTransfersByToAccountID", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAllTransfersByToAccountID indicates an expected call of GetAllTransfersByToAccountID.
func (mr *MockStoreMockRecorder) GetAllTransfersByToAccountID(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllTransfersByToAccountID", reflect.TypeOf((*MockStore)(nil).GetAllTransfersByToAccountID), arg0, arg1)
}
